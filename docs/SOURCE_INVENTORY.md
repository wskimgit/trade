...
| src/trade_runner_preflight.php | v1.4.6 / trade-low-load-runner-web-preflight-v146-dashboard-header-cleanup-20260923-r6 | IMPORTED |
| src/trade_dashboard.php | v3.4.11 / trade-dashboard-v3411-header-cleanup-20260923-r1 | IMPORTED |
| src/trade_3plus1_preflight.php | v1.3.18 / trade-3plus1-preflight-v1318-dashboard-header-cleanup-20260923-r1 | IMPORTED |
...
- Dashboard v3.4.11: removed a literal `\\n` rendered between the unified-analysis and JSON buttons and aligned visible version labels with the deployed revision.
