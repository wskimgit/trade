...
$expected = [
    ...
    'trade_runner_status.php' => 'trade-low-load-runner-status-v146-execution-truth-20260923-r1',
    'trade_runner_preflight.php' => 'trade-low-load-runner-web-preflight-v146-dashboard-header-cleanup-20260923-r6',
    'trade_dashboard.php' => 'trade-dashboard-v3411-header-cleanup-20260923-r1',
    'trade_3plus1_preflight.php' => 'trade-3plus1-preflight-v1318-dashboard-header-cleanup-20260923-r1',
